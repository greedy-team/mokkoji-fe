...
// import * as filterStore from "@/stores/useFilterStore";
...
//   beforeEach(() => {
//     vi.clearAllMocks(); //모든 목 함수 초기화

//     (filterStore.useFilterStore as vi.Mock).mockReturnValue({
//       selectedCategory: "전체",
//       searchText: "",
//       currentPage: 1,
//       setCurrentPage,
...
//     (clubsQuery.useGetClubs as vi.Mock).mockReturnValue({
//       data: {
//         data: {
//           clubs: [
//             {
